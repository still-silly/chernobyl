...
use crate::egui::{epaint, style};

// catppuccin_egui doesn't support egui 34 yet, and is also like 100 lines of relevant code
...
pub fn set_style_widgets(style: &mut egui::Style) {
